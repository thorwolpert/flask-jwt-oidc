...
@pytest.mark.parametrize(
    "test_name, jwt_role, endpoint_role, expected_code", decorator_role_test_data
)
def test_protected_auth_and_role(
    client, app, jwt, test_name, jwt_role, endpoint_role, expected_code
):
